...
points(x = 0, y = -6, pch = 17, col = rgb(0,0,1,1), cex = 1.8)
points(x = 2.360512, y = -11.561841, pch = 16, col = rgb(1,0,0,1), cex = 1.8)
legend("top", border = TRUE, legend = c("BFGS, SANN and Nelder-Mead", "PSO"),
       pch = c(17, 16), col = c(rgb(0,0,1,1), rgb(1,0,0,1)), cex = 1.3, pt.cex = 1.8)
dev.off()